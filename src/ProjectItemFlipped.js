...
class ProjectItemFlipped extends Component {
    render() {
                ...
                <div className={classes.ProjectItemRight}>
                    <div>
                        ...
                        <div className={classes.buttonsDiv}>
                            <a href={this.props.url} target="_blank">Visit Site</a>
                            <a href={this.props.github} target="_blank">Visit GitHub</a>
                        </div>
...
export default withStyles(styles)(ProjectItemFlipped);
